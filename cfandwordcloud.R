...
# clean this code up with the pipe operator, %>%, also read apply function and then
# create corpus of the movie titles
# clean the corpus movie object, removing stopwords, 
...
# 
table_of_genres <- table(genres_vec) %>%
  prop.table()
